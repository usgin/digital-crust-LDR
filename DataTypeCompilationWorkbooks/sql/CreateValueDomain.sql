...
('class/value-domain/era-of-geothermal-drilling', 'Era of geothermal drilling', 'Calendar defined time interval starting when the first geothermal well was drilled (guess 1/1/1800 to start)', 'def/concept/date-range', 'class/data-type/date', '', '', 'Use ISO8601 format', '1/1/1800', '', ''),
